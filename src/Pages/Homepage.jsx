...
const HomePage = () => {
  return (
    <div style={{width:"98.7vw"}} className={styles.home}>
      ...
      <div className={styles.workout} style={{ padding:"60px 0"}}>
      ...
      <div className={styles.spotlight} style={{ padding:"60px 0"}}>
      ...
      <div>
        <img style={{width:"100%"}} src="https://cdn-images.cure.fit/www-curefit-com/image/upload/fl_progressive,f_auto,q_auto:eco,w_1440/dpr_2/image/vm/0fcf2e11-e285-4bf4-ab60-35a039e2d399.png" alt="" />
      </div>
    </div>
  );
};
