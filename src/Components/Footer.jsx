...
const Footer = () => {
  return (
    <Box bg="#333" color="white"  p={8} display="flex" flexDirection={['column', 'column', 'row']} alignItems={['center', 'center', 'flex-start']} justifyContent="space-between"  marginBottom="-50px">
